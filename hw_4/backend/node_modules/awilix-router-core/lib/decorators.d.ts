 ...
 * @param path
 */
export declare function route(path: string): (target: any, name?: string | null) => void;
/**
 ...
 * @param middleware
 */
export declare function before(middleware: MiddlewareParameter): (target: any, name?: string | null) => void;
/**
 ...
 * @param middleware
 */
export declare function after(middleware: MiddlewareParameter): (target: any, name?: string | null) => void;
/**
