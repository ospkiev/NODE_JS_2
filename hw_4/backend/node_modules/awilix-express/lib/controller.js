...
function controller(ControllerClass) {
    ...
    if (Array.isArray(ControllerClass)) {
        ControllerClass.forEach(function (c) {
            return _registerController(router, (0, awilix_router_core_1.getStateAndTarget)(c));
        });
    }
    else {
        _registerController(router, (0, awilix_router_core_1.getStateAndTarget)(ControllerClass));
    }
    return router;
}
/**
...
function loadControllers(pattern, opts) {
    var router = (0, express_1.Router)();
    (0, awilix_router_core_1.findControllers)(pattern, tslib_1.__assign(tslib_1.__assign({}, opts), { absolute: true })).forEach(_registerController.bind(null, router));
    return router;
}
/**
...
function _registerController(router, stateAndTarget) {
    ...
    rolledUp.forEach(function (methodCfg, methodName) {
        methodCfg.verbs.forEach(function (httpVerb) {
            ...
            ;
            (_a = router)[method].apply(_a, tslib_1.__spreadArray(tslib_1.__spreadArray(tslib_1.__spreadArray([methodCfg.paths], methodCfg.beforeMiddleware, false), [
                /*tslint:disable-next-line*/
                (0, invokers_1.makeInvoker)(target)(methodName)], false), methodCfg.afterMiddleware, false));
        });
    });
}
